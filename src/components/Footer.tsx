  ...
  return (
    <footer className="footer p-10 bg-neutral text-neutral-content">
      <div>
        ...
        <p>TechSite Ltd.<br />Providing reliable tech since 2023</p>
      </div>
      <div>
        <span className="footer-title">Services</span>
        <Link href="/services/design" className="link link-hover">Design</Link>
        <Link href="/services/development" className="link link-hover">Development</Link>
        <Link href="/services/consulting" className="link link-hover">Consulting</Link>
        <Link href="/services/support" className="link link-hover">Support</Link>
      </div>
      <div>
